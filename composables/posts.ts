  ...
  works: [
    ...
    },
    {
      ...
      credits: [
        ...
        { title: 'Art director', name: 'Nagisa Chen' },
    ...
    },
    {
      ...
      credits: [
        ...
        { title: 'Art director', name: 'Willie Liu' },
    ...
    },
    {
      ...
      credits: [
        ...
        { title: 'Lead agency', name: 'LxU' },
        { title: 'Type director', name: 'Willie Liu' },
    ...
    },
    {
      ...
      name: 'Glyphs 3 Event',
      date: '2020-11-01',
      category: ['Motion graphic', 'Graphic design'],
      credits: [
  ...
  typefaces: [
    ...
    },
    {
      ...
      credits: [
        ...
        { title: 'Creative director', name: 'Zhengzhong Pan @Studio Bibliography' },
        { title: 'Type director', name: 'Nagisa Chen' },
  ...
  dash: [
    {
      ...
      credits: [
        { title: 'Chief editor', name: 'Xiyao Du' },
        {
          title: 'Author',

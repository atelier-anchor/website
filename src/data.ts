...
export const works: Record<string, Work> = {
  agt: {
    ...
    images: [
      { name: 'agt-1', type: ['webp', 'jpg'] },
      { name: 'agt-2', type: ['webp', 'gif'] },
      { name: 'agt-3', type: ['webp', 'jpg'] },
      { name: 'agt-4', type: ['webp', 'jpg'] },
    ],
    description: [
  ...
  ambitful: {
    ...
    images: [
      { name: 'ambitful-1', type: ['webp', 'jpg'] },
      { name: 'ambitful-2', type: ['webp', 'jpg'] },
      { name: 'ambitful-3', type: ['webp', 'jpg'] },
      { name: 'ambitful-4', type: ['webp', 'jpg'] },
      { name: 'ambitful-5', type: ['webp', 'jpg'] },
    ],
    description: [
  ...
  'black-box': {
    ...
    images: [
      { name: 'black-box-1', type: ['webp', 'jpg'] },
      { name: 'black-box-2', type: ['webp', 'jpg'] },
      { name: 'black-box-3', type: ['webp', 'jpg'] },
      { name: 'black-box-4', type: ['webp', 'jpg'] },
      { name: 'black-box-5', type: ['webp', 'jpg'] },
    ],
    description: [
  ...
  'chen-shi-fu-hua': {
    ...
    images: [
      { name: 'chen-shi-fu-hua-1', type: ['webp', 'jpg'] },
      { name: 'chen-shi-fu-hua-2', type: ['webp', 'jpg'] },
    ],
  },
  'dangxia-tiu': {
    name: 'This is Us',
    ...
    images: [
      { name: 'dangxia-tiu-1', type: ['webp', 'jpg'] },
      { name: 'dangxia-tiu-2', type: ['webp', 'jpg'] },
      { name: 'dangxia-tiu-3', type: ['webp', 'jpg'] },
      { name: 'dangxia-tiu-4', type: ['webp', 'jpg'] },
      { name: 'dangxia-tiu-5', type: ['webp', 'jpg'] },
    ],
    description: [
  ...
  'double-win': {
    ...
    images: [
      { name: 'double-win-1', type: ['webp', 'jpg'] },
      { name: 'double-win-2', type: ['webp', 'jpg'] },
      { name: 'double-win-3', type: ['webp', 'jpg'] },
      { name: 'double-win-4', type: ['webp', 'jpg'] },
      { name: 'double-win-5', type: ['webp', 'jpg'] },
      { name: 'double-win-6', type: ['webp', 'jpg'] },
      { name: 'double-win-7', type: ['webp', 'jpg'] },
    ],
    videos: [
  ...
  'freds-inside': {
    ...
    images: [
      { name: 'freds-inside-1', type: ['webp', 'gif'] },
      { name: 'freds-inside-2', type: ['webp', 'gif'] },
      { name: 'freds-inside-3', type: ['webp', 'jpg'] },
      { name: 'freds-inside-4', type: ['webp', 'jpg'] },
    ],
    description: [
  ...
  g3: {
    ...
    images: [
      { name: 'g3-1', type: ['webp', 'jpg'] },
      { name: 'g3-2', type: ['webp', 'jpg'] },
      { name: 'g3-3', type: ['webp', 'jpg'] },
      { name: 'g3-4', type: ['webp', 'jpg'] },
    ],
    videos: [
  ...
  kuusi: {
    ...
    images: [
      { name: 'kuusi-1', type: ['webp', 'jpg'] },
      { name: 'kuusi-2', type: ['webp', 'jpg'] },
      { name: 'kuusi-3', type: ['webp', 'jpg'] },
      { name: 'kuusi-4', type: ['webp', 'jpg'] },
      { name: 'kuusi-5', type: ['webp', 'jpg'] },
    ],
    description: [
  ...
  'out-of-mountain': {
    ...
    images: [
      { name: 'out-of-mountain-1', type: ['webp', 'jpg'] },
      { name: 'out-of-mountain-2', type: ['webp', 'jpg'] },
      { name: 'out-of-mountain-3', type: ['webp', 'jpg'] },
      { name: 'out-of-mountain-4', type: ['webp', 'jpg'] },
      { name: 'out-of-mountain-5', type: ['webp', 'jpg'] },
    ],
    description: [
  ...
  psa: {
    ...
    images: [
      { name: 'psa-1', type: ['webp', 'jpg'] },
      { name: 'psa-2', type: ['webp', 'jpg'] },
      { name: 'psa-3', type: ['webp', 'jpg'] },
      { name: 'psa-4', type: ['webp', 'jpg'] },
      { name: 'psa-5', type: ['webp', 'jpg'] },
    ],
    description: [
  ...
  'receipt-poster': {
    ...
    images: [
      { name: 'receipt-poster-1', type: ['webp', 'jpg'] },
      { name: 'receipt-poster-2', type: ['webp', 'jpg'] },
      { name: 'receipt-poster-3', type: ['webp', 'jpg'] },
      { name: 'receipt-poster-4', type: ['webp', 'jpg'] },
    ],
  },
  vip: {
    ...
    images: [
      { name: 'vip-1', type: ['webp', 'jpg'] },
      { name: 'vip-2', type: ['webp', 'jpg'] },
    ],
    videos: [
      {
        source: 'vip-3.webm',
...
export const typefaces: Record<string, Work> = {
  ...
  tbh: {
    ...
    images: [
      ...
      { name: 'tbh-5', type: ['webp', 'gif'] },
      { name: 'tbh-6', type: ['webp', 'jpg'] },
    ],
    description: [
...
export const dash: Record<string, Work> = {
  'dash-0': {
    ...
    images: [
      { name: 'dash-0-1', type: ['webp', 'jpg'] },
      { name: 'dash-0-2', type: ['webp', 'jpg'] },
      { name: 'dash-0-3', type: ['webp', 'jpg'] },
      { name: 'dash-0-4', type: ['webp', 'jpg'] },
      { name: 'dash-0-5', type: ['webp', 'jpg'] },
      { name: 'dash-0-6', type: ['webp', 'jpg'] },
      { name: 'dash-0-7', type: ['webp', 'jpg'] },
      { name: 'dash-0-8', type: ['webp', 'jpg'] },
      { name: 'dash-0-9', type: ['webp', 'jpg'] },
      { name: 'dash-0-10', type: ['webp', 'jpg'] },
      { name: 'dash-0-11', type: ['webp', 'jpg'] },
    ],
    description: [
